...
namespace DataCloner.Core.PlugIn
{
    internal static class DataBuilder
    {
        ...
        public static void BuildDataFromTable(IQueryProvider queryHelper, IDbTransaction transaction, string serverId, string database, string schema, TableMetadata table, object[] dataRow)
        {
