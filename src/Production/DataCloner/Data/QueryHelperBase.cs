...
namespace DataCloner.Data
{
    internal abstract class QueryHelperBase : IQueryHelper
    {
        ...
        public void Execute(Internal.ExecutionPlan plan)
        {
        ...
        private void TryExecute(Internal.ExecutionPlan plan, StringBuilder query, IDbTransaction transaction, ref IDbCommand cmd, 
        ...
        private void Execute(Internal.ExecutionPlan plan, StringBuilder query, IDbTransaction transaction,
        ...
        private void RetriveOutputParams(Internal.ExecutionPlan plan, IDbCommand cmd)
        {
        ...
        private static void RetriveAutoGeneratedPk(Internal.ExecutionPlan plan, IDataReader dr)
        {
            //Pour chaque requête
            do
            {
