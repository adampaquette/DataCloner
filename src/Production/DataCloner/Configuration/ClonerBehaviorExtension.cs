    ...
    public static class ClonerBehaviourExtension
    {
                                        ...
                                        ServerModifier srvToMerge)
        {
            ...
            if (srvToMerge.Id.IsVariable())
                srvToMerge.Id = variables.First(v => v.Name == srvToMerge.Id.ParseConfigVariable().Key).Value;
                                          ...
                                          DatabaseModifier dbToMerge)
        {
            ...
            if (dbToMerge.Name.IsVariable())
                dbToMerge.Name = variables.First(v => v.Name == dbToMerge.Name.ParseConfigVariable().Key).Value;
                                        ...
                                        SchemaModifier schemaToMerge)
        {
            ...
            if (schemaToMerge.Name.IsVariable())
                schemaToMerge.Name = variables.First(v => v.Name == schemaToMerge.Name.ParseConfigVariable().Key).Value;
                                       ...
                                       TableModifier tblToMerge)
        {
            ...
            if (tblToMerge.Name.IsVariable())
                tblToMerge.Name = variables.First(v => v.Name == tblToMerge.Name.ParseConfigVariable().Key).Value;
