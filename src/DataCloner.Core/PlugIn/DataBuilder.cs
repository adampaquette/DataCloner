...
namespace DataCloner.Core.PlugIn
{
    internal static class DataBuilder
    {
        ...
        public static object BuildDataColumn(IQueryProvider queryProvider, IDbTransaction transaction, short serverId, string database, string schema, TableMetadata table, ColumnDefinition col)
        {
        ...
        public static void BuildDataFromTable(IQueryProvider queryHelper, IDbTransaction transaction, short serverId, string database, string schema, TableMetadata table, object[] dataRow)
        {
